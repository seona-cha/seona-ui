import { Input, CodeContainer } from '@seona/sui-core'
import { useState } from 'react'
import type { InputProps } from '@seona/sui-core'
...
<Input size="lg" name="input-size-lg" id="input-size-lg" />`}
            ...
            <div className="sui-guide__content-item">
              <Input type="text" name="input-radius" id="input-radius" value={InputProps.radius} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, radius: e.target.value as `${number}px` })} />
              <input type="range" min="0" max="24" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, radius: e.target.value + 'px' as `${number}px` })} />
...
<Input type="text" name="input-error" id="input-error" />`}
          ...
          <div className="sui-guide__control">
            <Input
              {...InputProps}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, value: e.target.value })}
            ...
            <div className="sui-guide__control-group">
              <div>
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, placeholder: e.target.value })}
                />
              </div>
              <div>
                <label>사이즈</label>
                <select value={InputProps.size} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setInputProps({ ...InputProps, size: e.target.value as 'sm' | 'md' | 'lg' })}>
              ...
              <div>
                <label>모양</label>
                <select value={InputProps.variant} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setInputProps({ ...InputProps, variant: e.target.value as 'filled' | 'outlined' | 'underline' })}>
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  size="md"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, radius: e.target.value + 'px' as `${number}px` })}
              ...
              <div>
                <label>비활성화</label>
                <input type="checkbox" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setInputProps({ ...InputProps, disabled: e.target.checked })} />
              </div>
              <div>
