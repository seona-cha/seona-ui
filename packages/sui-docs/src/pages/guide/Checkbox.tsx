import { Checkbox, Input } from '@seona/sui-core'
import { useState } from 'react'
import type { CheckboxProps } from '@seona/sui-core'
      ...
      <div className="sui-page-wrapper">
        <div className="sui-guide">
          ...
          <div className="sui-guide__control">
            <Checkbox
              {...CheckboxProps}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCheckboxProps({ ...CheckboxProps, checked: e.target.checked })}
            />
            <div className="sui-guide__control-group">
              <div>
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCheckboxProps({ ...CheckboxProps, label: e.target.value })}
                />
              </div>
              <div>
                <label>사이즈</label>
