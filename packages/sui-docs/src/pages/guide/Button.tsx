import { Button, Input, CodeContainer } from '@seona/sui-core'
import { useState } from 'react'
import type { ButtonProps } from '@seona/sui-core'
...
<Button variant="text">Text</Button>`}
            ...
            <div className="sui-guide__content-item">
              <Input type="text" name="button-radius" id="button-radius" value={buttonProps.radius} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, radius: e.target.value as `${number}px` })} />
                              <input type="range" min="0" max="24" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, radius: e.target.value + 'px' as `${number}px` })} />
            ...
            <div className="sui-guide__control-group">
              <div>
                ...
                <Input
                  ...
                  id="button-children"
                  type="text"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, children: e.target.value })}
                  value={buttonProps.children as string}
                />
              </div>
              <div>
                <label>사이즈</label>
                <select value={buttonProps.size} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setButtonProps({ ...buttonProps, size: e.target.value as 'sm' | 'md' | 'lg' })}>
              ...
              <div>
                <label>모양</label>
                <select value={buttonProps.variant} onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setButtonProps({ ...buttonProps, variant: e.target.value as 'contained' | 'outlined' | 'text' })}>
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  size="md"
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, radius: e.target.value + 'px' as `${number}px` })}
              ...
              <div>
                <label>기본 색상</label>
                <input type="color" value={buttonProps.btnColor} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, btnColor: e.target.value })} />
              </div>
              <div>
                <label>hover 색상</label>
                <input type="color" value={buttonProps.hoverColor} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, hoverColor: e.target.value })} />
              </div>
              <div>
                <label>텍스트 색상</label>
                <input type="color" value={buttonProps.textColor || (buttonProps.variant === 'contained' ? '#ffffff' : '#4F46E5')} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, textColor: e.target.value })} />
              </div>
              <div>
                <label>비활성화</label>
                <input type="checkbox" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, disabled: e.target.checked })} />
              </div>
              <div>
                <label>Full Width</label>
                <input type="checkbox" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, fullWidth: e.target.checked })} />
              </div>
              <div>
                <label>hover 효과</label>
                <input type="checkbox" checked={buttonProps.hoverEffect} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setButtonProps({ ...buttonProps, hoverEffect: e.target.checked })} />
              </div>
            </div>
            <CodeContainer>
              {`<Button
