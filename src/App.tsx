        ...
        <div className="sui-guide">
          ...
          <div className="sui-guide__control">
            ...
            <div className="sui-guide__control-group">
              <div>
                <label>사이즈</label>
                <select value={radioProps.size} onChange={(e) => setRadioProps({ ...radioProps, size: e.target.value as 'sm' | 'md' | 'lg' })}>
                  <option value="sm">sm</option>
                  <option value="md">md</option>
                  <option value="lg">lg</option>
                </select>
              ...
              <div>
                <label>모양</label>
                <select value={radioProps.variant} onChange={(e) => setRadioProps({ ...radioProps, variant: e.target.value as 'square' | 'circle' })}>
                  <option value="circle">circle</option>
                  <option value="square">square</option>
                </select>
              </div>
              <div>
                <label>방향</label>
                <select value={radioProps.direction} onChange={(e) => setRadioProps({ ...radioProps, direction: e.target.value as 'horizontal' | 'vertical' })}>
                  <option value="horizontal">horizontal</option>
                  <option value="vertical">vertical</option>
                </select>
              </div>
              <div>
                <label>색상</label>
                <input type="color" value={radioProps.color} onChange={(e) => setRadioProps({ ...radioProps, color: e.target.value })} />
              </div>
              <div>
                <label>레이블 숨김</label>
